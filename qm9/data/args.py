...
def setup_shared_args(parser):
    ...
    # Directory to read and save mol_data from
    parser.add_argument('--datadir', type=str, default='qm9/temp',
                        help='Directory to look up mol_data from. (default: mol_data/)')
...
def setup_argparse(dataset):
    ...
    if dataset == "md17":
        parser.add_argument('--subset', '--molecule', type=str, default='',
                            help='Subset/molecule on mol_data with subsets (such as md17).')
    elif dataset == "qm9":
