...
def load_split_data(conformation_file, val_proportion=0.1, test_proportion=0.1,
    ...
    val_data = data_list[0:val_index]
...
class GeomDrugsDataLoader(DataLoader):
    def __init__(self, sequential, dataset, batch_size, shuffle, num_workers, sampler, pin_memory, drop_last=False):
        ...
        if sequential:
            ...
            super().__init__(dataset, batch_sampler=batch_sampler, num_workers=num_workers)
